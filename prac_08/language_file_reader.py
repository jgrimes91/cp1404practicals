...
def main():
    ...
    for line in in_file:
        ...
        pointed_arithmetric = parts[3] == "Yes"
        # construct a ProgrammingLanguage object using the elements
        # year should be an int
        language = ProgrammingLanguage(parts[0], parts[1], reflection, pointed_arithmetric,
                                       int(parts[4]))
...
def using_namedtuple():
    ...
    Language = namedtuple('Language', 'name, typing, reflection, pointed arithmetic, year')
    reader = csv.reader(in_file)  # use default dialect, Excel
